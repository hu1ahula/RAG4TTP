...
from libs.pygaggle.rerank.bm25 import Bm25Reranker, Bm25PlusReranker, RM3BM25Reranker, QLReranker
...
def construct_ql():
    return QLReranker(mu=2000)

def construct_rm3():
    return RM3BM25Reranker(k1=1.2, b=0, top_k=70, alpha=0.8)

def construct_bm25plus() -> Reranker:
    return Bm25PlusReranker()
